...
export default function Banner({type} : {type : "Baru" | "Sudah Ada"}){
    return <section className="w-full min-h-screen bg-[#EBEFFF] gap-5 justify-center lg:gap-16 text-right text-[#3B387E] flex flex-col-reverse lg:flex-row p-5 lg:p-32 items-center">
