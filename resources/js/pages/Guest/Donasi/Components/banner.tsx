...
export default function Banner() {
    return (
        <div className="min-h-screen w-full bg-[#EBEFFF]">
            <section className="flex min-h-screen w-full flex-col-reverse gap-10 px-5 text-right lg:flex-row lg:px-20">
            ...
            <section className="flex min-h-screen w-full gap-20 px-5 text-right lg:px-20">
