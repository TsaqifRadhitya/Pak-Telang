            ...
            <main className="h-full w-full rounded-t-lg border-[1px] border-b-0 border-[#AFB3FF] bg-[#FFFFFF] shadow-lg">
                <div className="flex items-center justify-between border-b-[1px] border-[#AFB3FF] p-5 md:px-10 md:py-5">
                    ...
                    <div className="flex flex-2/5 gap-x-3">
                        ...
                        className="flex-1/2 cursor-pointer bg-[#FFA114] text-white hover:bg-[#d68f24]">Edit</Button>
                        <Button
                ...
                <div className="flex min-h-full w-full flex-col gap-y-5 lg:gap-20 p-5 lg:p-10 ">
                    <div className="flex flex-col gap-y-5 lg:flex-row lg:gap-x-16 items-center">
                        ...
                        <article className="text-[#3B387E] space-y-2.5">
                            ...
                            <p>
                                Tanggal Lahir : {auth.user.birthday?.getDate()} {auth.user.birthday?.getMonth()} {auth.user.birthday?.getFullYear()}
                            </p>
                    ...
                    <article className="text-[#3B387E] space-y-2.5">
                        ...
                        <p>
                            No. Hp : {auth.user.phonenumber} {auth.user.birthday?.getMonth()} {auth.user.birthday?.getFullYear()}
                        </p>
                        <p>Alamat : {auth.user.gender}</p>
                    </article>
                </div>
            </main>
        </AdminPageLayout>
